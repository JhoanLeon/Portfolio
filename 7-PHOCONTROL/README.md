...
With this premise, I started the design. First I choose SMT components to facilitate the assembly process and modernize the design from that Chinese style of 80s electronics. Then I make a lot of mistakes: Wrong track size calculations, very poor selection of components and of course the challenge of meet regulations for these equipment with the minimum possible.

This was a real challenge for me because of the requirements to work directly with 110-220VAC and also deal with the strict regulations for the operation and manufacturing of this equipment. I remember that the first prototypes just blow up on some components when you plug in the 110VAC. Then, the design was refined and could manage without any problem the full range of input AC voltage. The latter problem was comply with the standard of luxes required for the application. It's curious that regulations prohibit the use of photoresistors and require the use of photodiodes or phototransistors instead. The calibration process for this device was not easy. We had to spent a lot of time in laboratory in the dark to measure the precise luxes for the lamp, but at the end, I was able to finish the design and deliver it satisfactorily to the client.
